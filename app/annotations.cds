...
annotate akhilasiripurapu_1_d02Srv.CustomerMessages with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate akhilasiripurapu_1_d02Srv.CustomerMessages with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate akhilasiripurapu_1_d02Srv.CustomerMessages with @UI.Identification: [{ Value: customerMessageID }];
annotate akhilasiripurapu_1_d02Srv.CustomerMessages with {
...
annotate akhilasiripurapu_1_d02Srv.CustomerMessages with @UI.LineItem: [
...
annotate akhilasiripurapu_1_d02Srv.CustomerMessages with @UI.FieldGroup #Main: {
...
annotate akhilasiripurapu_1_d02Srv.CustomerMessages with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate akhilasiripurapu_1_d02Srv.CustomerMessages with @UI.SelectionFields: [
  customerMessageID
];
